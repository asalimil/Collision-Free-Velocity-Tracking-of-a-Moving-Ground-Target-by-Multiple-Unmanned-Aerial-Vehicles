...
if __name__ == '__main__':
    ...
    rospy.sleep(0.5)
    #
    rospy.wait_for_service('cf3/update_params')
    rospy.loginfo("found update_params service")
    update_params = rospy.ServiceProxy('cf3/update_params', UpdateParams)
    rospy.set_param("kalman/resetEstimation", 1)
    update_params(["kalman/resetEstimation"])
    rospy.sleep(0.1)
    rospy.set_param("kalman/resetEstimation", 0)
    ...
    rospy.sleep(0.5)
    #
    rospy.wait_for_service('cf4/update_params')
    rospy.loginfo("found update_params service")
    update_params = rospy.ServiceProxy('cf4/update_params', UpdateParams)
    rospy.set_param("kalman/resetEstimation", 1)
    update_params(["kalman/resetEstimation"])
    rospy.sleep(0.1)
    rospy.set_param("kalman/resetEstimation", 0)
    ...
    rospy.sleep(0.5)
    #
    rospy.wait_for_service('cf5/update_params')
    rospy.loginfo("found update_params service")
    update_params = rospy.ServiceProxy('cf5/update_params', UpdateParams)
    rospy.set_param("kalman/resetEstimation", 1)
    update_params(["kalman/resetEstimation"])
    rospy.sleep(0.1)
    rospy.set_param("kalman/resetEstimation", 0)
    ...
    while not rospy.is_shutdown():
        ...
        for h in range(H):
            ...
            msg_position_cf5.x = 0.0; msg_position_cf5.y = 0.0; msg_position_cf5.z = h/D
	    ...
	    #
            ...
            pub_position_cf5.publish(msg_position_cf5)
    ...
    # tb3 cmd_vel
    radius = 0.25
    v_tb3 = 0.05; w_tb3 = v_tb3/radius # Circular path r = 0.25
    ...
    for h in range(H):
        ...
        msg_position_cf5.x = x5_local[0]; msg_position_cf5.y = x5_local[1]; msg_position_cf5.z = zz
	#
        # now = rospy.get_time()
        if (zz < 0.1):
            break
    ...
    pub_stop_cf5.publish(msg_stop_cf5)
